 ...
 *
 * If your current version is 1.21 and you call `rollback --force`, it won't do anything.
 * Because we not yet support a specific version to rollback. knex-migrator does not know
 * where to rollback to.
 *
